...
try {
    ...
    $mail->Username = 'xx@gmail.com';                 // 用来发送邮件的邮箱
    $mail->Password = '';                      // 用来发送邮件的邮箱的密码，这里这个乱码是我生成的应用程序专用密码
    $mail->SMTPSecure = 'tls';                            // 加密方式，tls和ssl都可以
    $mail->Port = 587;                                    // 对于gmail，tls对应587端口，ssl对应465端口，国内大部分应该是25端口

    //这些配置主要影响邮件上的显示，你测试即知
    $mail->setFrom('xx@gmail.com', 'Lejian Ren');    //源地址，后面的名字可选
    $mail->addAddress('xx@qq.com');    //目标地址
    $mail->addReplyTo('xx@gmail.com', 'name');    //收到邮件后reply ，reply all那个地址
    $mail->addCC('xx@163.com');    //抄送地址
    //$mail->addBCC('xx@163.com');    //这个是什么抄送没仔细看。。。
